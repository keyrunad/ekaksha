		<?php 
		include('config.php');
		if((!isset($_POST['search'])==true)||empty($_POST['search'])){
		...
		$sql_class=mysqli_query($conn, "Select * from class WHERE class_name like '%$keyword%' AND c_status = 'Active' ORDER BY doc");
		}
